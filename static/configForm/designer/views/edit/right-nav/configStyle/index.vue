<template>
  <el-dialog class="dialog-container" :visible.sync="isShowDialog" title="配置样式（style）" append-to-body>
...
export default {
  ...
  methods: {
    ...
    ok() {
      ...
      if (!valid) {
        this.$errorTips(`【${curParseData}】格式错误，JSON.parse 转换失败`);
        return;
      }
      this.$emit('change', o);
      console.log('ok', o);
