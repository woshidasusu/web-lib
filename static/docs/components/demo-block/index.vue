<template>
  ...
  >
    ...
    <div ref="control" :class="['demo-block-control', { 'is-fixed': isExpanded }]" @click="isExpanded = !isExpanded">
      ...
      <div class="control-button-container">
        ...
        <el-tooltip effect="dark" content="在线运行此示例" placement="right">
          <transition name="text-slide">
            <el-button
              v-show="hovering || isExpanded"
              size="small"
...
export default {
  ...
  methods: {
    ...
    handleCodeView() {
      ...
      local.set('kf-preview-source', codeSource);
